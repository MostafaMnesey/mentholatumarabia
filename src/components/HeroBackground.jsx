...
export default function HeroBackground({ hlsUrl, bgImage = "https://cdn.mentholatumarabia.com/web/home-hero.webp", isHome = false, children }) {
  ...
  return (
    <div
      className={`relative w-full overflow-hidden flex items-center justify-center max-h-[50vh] lg:max-h-[70vh] min-h-100 ${isLoading && !hasError ? "before:content-[''] before:absolute before:inset-0 before:backdrop-blur-sm before:bg-black/30 before:z-4" : ""}`}
      style={{ height: "95vh" }}
    >
      {/* Crossfade hero image — mode="sync" avoids layout animation dependency */}
