export const getSymptomData = (t) => ({
    ...
    products: [
      {
        ...
        image: "https://api.mentholatumarabia.com/uploads/products/2025073114121-01.png",
      ...
      },
      {
        ...
        image: "https://api.mentholatumarabia.com/uploads/products/20250731141311-01.png",
    ...
    products: [
      {
        ...
        image: "https://api.mentholatumarabia.com/uploads/products/2025073113029-01.png",
      ...
      },
      {
        ...
        image: "https://api.mentholatumarabia.com/uploads/products/2025073114123-01.png",
        brandName: t("footer.brands.items.deepFreeze"),
    ...
    products: [
      {
        ...
        image: "https://api.mentholatumarabia.com/uploads/products/20250731141435-01.png",
        brandName: t("footer.brands.items.deepFreeze"),
    ...
    products: [
      {
        ...
        image: "https://api.mentholatumarabia.com/uploads/products/2025073113017-01.png",
        brandName: t("footer.brands.items.deepHeat"),
        productName: t("symptom.pain_relief.back.products.deep_heat_pain_relief_back_patch.name")
      },
      {
        slug: "deep-heat-warming-belt",
        image: "https://api.mentholatumarabia.com/uploads/products/20250731130434-01.png",
        brandName: t("footer.brands.items.deepHeat"),
    ...
    products: [
      {
        ...
        image: "https://api.mentholatumarabia.com/uploads/products/2025073113006-01.png",
        brandName: t("footer.brands.items.deepHeat"),
      ...
      },
      {
        ...
        image: "https://api.mentholatumarabia.com/uploads/products/2025073113038-01.png",
        brandName: t("footer.brands.items.deepHeat"),
  ...
  Muscles: {
    ...
    products: [
      ...
      {
        slug: "deep-heat-rub",
        image: "https://api.mentholatumarabia.com/uploads/products/20250731125910-01.png",
        brandName: t("footer.brands.items.deepHeat"),
